...
let selectList = function() {
    let selectList = [{
        ...
        optionList: [
            { value: 0, text: '待初始化' },
            { value: 1, text: '空白記錄' },
            { value: 2, text: '新建記錄(待儲存)' },
            { value: 3, text: '歷史記錄' },
            { value: 4, text: '歷史記錄(待儲存)' }
        ]
    }, {
        id: 'bmHolder',
        optionList: [
            { value: 'NO.1 SG', text: 'NO.1 SG' },
            { value: 'NO.2 SG', text: 'NO.2 SG' },
            { value: 'NO.3 SG', text: 'NO.3 SG' },
            { value: 'NO.4 SG', text: 'NO.4 SG' },
            { value: 'NO.5 SG', text: 'NO.5 SG' },
            { value: 'NO.6 SG', text: 'NO.6 SG' },
            { value: 'NO.7 SG', text: 'NO.7 SG' },
            { value: 'NO.8 SG', text: 'NO.8 SG' },
            { value: 'NO.1-1 SG (DG 尺寸)', text: 'NO.1-1 SG (DG 尺寸)' },
            { value: 'NO.1-2 SG (DG 尺寸)', text: 'NO.1-2 SG (DG 尺寸)' },
            { value: 'NO.1 SG (DG 尺寸)', text: 'NO.1 SG (DG 尺寸)' },
            { value: 'NO.2 SG (DG 尺寸)', text: 'NO.2 SG (DG 尺寸)' },
            { value: 'NO.3 SG (DG 尺寸)', text: 'NO.3 SG (DG 尺寸)' },
            { value: 'NO.4 SG (DG 尺寸)', text: 'NO.4 SG (DG 尺寸)' },
            { value: 'NO.5 SG (DG 尺寸)', text: 'NO.5 SG (DG 尺寸)' },
            { value: 'NO.6 SG (DG 尺寸)', text: 'NO.6 SG (DG 尺寸)' },
            { value: 'NO.7 SG (DG 尺寸)', text: 'NO.7 SG (DG 尺寸)' },
            { value: 'NO.8 SG (DG 尺寸)', text: 'NO.8 SG (DG 尺寸)' },
            { value: 'NO.12 SG (DG 尺寸)', text: 'NO.12 SG (DG 尺寸)' },
            { value: 'NO.13 SG (DG 尺寸)', text: 'NO.13 SG (DG 尺寸)' },
            { value: 'NO.16 SG (DG 尺寸)', text: 'NO.16 SG (DG 尺寸)' },
            { value: 'NO.17 SG (DG 尺寸)', text: 'NO.17 SG (DG 尺寸)' },
            { value: 'Φ65 DG', text: 'Φ65 DG' },
            { value: 'Φ75 DG', text: 'Φ75 DG' },
            { value: 'NO.1 DG', text: 'NO.1 DG' },
            { value: 'NO.2 DG', text: 'NO.2 DG' },
            { value: 'NO.3 DG', text: 'NO.3 DG' },
            { value: 'NO.4 DG', text: 'NO.4 DG' },
            { value: 'NO.5 DG', text: 'NO.5 DG' },
            { value: 'NO.6 DG', text: 'NO.6 DG' },
            { value: 'NO.7 DG', text: 'NO.7 DG' },
            { value: 'NO.8 DG', text: 'NO.8 DG' },
            { value: 'Φ108 DG', text: 'Φ108 DG' }
        ]
    }, {
        id: 'fmHolder',
        optionList: [
        ...
        optionList: [
            { value: '3&quot;', text: '3&quot;' },
            { value: 'NO. 1', text: 'NO. 1' },
            { value: 'NO. 2', text: 'NO. 2' },
            { value: 'NO. 3', text: 'NO. 3' }
        ]
    }, {
        id: 'fuArm',
        optionList: [
        ...
        optionList: [
            ...
            { value: '70mm', text: '70mm' },
            { value: '70mm (特殊)', text: '70mm (特殊)' }
        ]
    }, {
        id: 'plPositioner',
        optionList: [
            { value: 'B/B SG', text: 'B/B SG' },
            { value: 'B/B DG', text: 'B/B DG' },
            { value: 'P/B SG', text: 'P/B SG' },
            { value: 'P/B DG', text: 'P/B DG' }
        ]
    }, {
        id: 'scoop',
        optionList: [
            { value: '5/8', text: '5/8' },
            { value: '3/8-3/4', text: '3/8-3/4' },
            { value: 'NO.0-2', text: 'NO.0-2' },
            { value: 'NO.1', text: 'NO.1' },
            { value: 'NO.2', text: 'NO.2' },
            { value: 'NO.3', text: 'NO.3' },
            { value: 'NO.4', text: 'NO.4' },
            { value: 'NO.5', text: 'NO.5' },
            { value: 'NO.2-3', text: 'NO.2-3' },
            { value: 'NO.3-4', text: 'NO.3-4' },
            { value: 'NO.0', text: 'NO.0' }
        ]
    }, {
        id: 'trough',
        optionList: [
        ...
        optionList: [
            ...
            { value: '7/8&quot;', text: '7/8&quot;' },
            { value: '1&quot;', text: '1&quot;' },
            { value: '1-1/8&quot;', text: '1-1/8&quot;' },
            { value: '1-1/4&quot;', text: '1-1/4&quot;' },
            { value: '1-3/8&quot;', text: '1-3/8&quot;' },
            { value: '1-1/2&quot;', text: '1-1/2&quot;' },
            { value: '1-5/8&quot;', text: '1-5/8&quot;' },
            { value: '1-3/4&quot;', text: '1-3/4&quot;' },
            { value: '1-7/8&quot;', text: '1-7/8&quot;' },
            { value: '2&quot;', text: '2&quot;' },
            { value: '2-1/8&quot;', text: '2-1/8&quot;' },
            { value: '2-3/8&quot;', text: '2-3/8&quot;' },
            { value: '2-1/4&quot;', text: '2-1/4&quot;' },
            { value: '2-3/4&quot;', text: '2-3/4&quot;' }
        ]
    }, {
        id: 'orificeRing',
        optionList: [{
        ...
        id: 'shearCam',
        optionList: [
            { value: '20°', text: '20°', displayFlag: false },
            { value: '31°', text: '31°', displayFlag: true },
            { value: '41°', text: '41°', displayFlag: true },
            { value: '49°', text: '49°', displayFlag: true },
            { value: '50°', text: '50°', displayFlag: false },
            { value: '61°', text: '61°', displayFlag: true },
            { value: '65°', text: '65°', displayFlag: false },
            { value: '70°', text: '70°', displayFlag: true },
            { value: '80°', text: '80°', displayFlag: true },
            { value: '91°', text: '91°', displayFlag: true },
            { value: '106°', text: '106°', displayFlag: true },
            { value: '113°', text: '113°', displayFlag: true },
            { value: '特殊', text: '特殊', displayFlag: false }
        ]
    }, {
        id: 'shear',
        optionList: [
            { value: 'NO.1', text: 'NO.1' },
            { value: 'NO.285', text: 'NO.285' },
            { value: 'NO.375', text: 'NO.375' },
            { value: 'NO.4', text: 'NO.4' }
        ]
    }, {
        id: 'plunger',
        optionList: [
            { value: '29-610', text: '29-610', displayFlag: true },
            { value: '29-611', text: '29-611', displayFlag: true },
            { value: '29-612', text: '29-612', displayFlag: true },
            { value: '58-2573', text: '58-2573', displayFlag: true },
            { value: '58-2574', text: '58-2574', displayFlag: true },
            { value: '58-2575', text: '58-2575', displayFlag: true },
            { value: '81-3920', text: '81-3920', displayFlag: true },
            { value: '81-3928', text: '81-3928', displayFlag: true },
            { value: '81-3928(研磨)', text: '81-3928(研磨)', displayFlag: true },
            { value: '81-3929', text: '81-3929', displayFlag: true },
            { value: '81-3929(研磨)', text: '81-3929(研磨)', displayFlag: true }
        ]
    }, {
        id: 'plungerCam',
        optionList: [
            { value: 'NO.1', text: 'NO.1', displayFlag: true },
            { value: 'NO.2', text: 'NO.2', displayFlag: true },
            { value: 'NO.3', text: 'NO.3', displayFlag: true },
            { value: 'NO.4', text: 'NO.4', displayFlag: true },
            { value: 'NO.4-1/2', text: 'NO.4-2/1', displayFlag: false },
            { value: 'NO.5', text: 'NO.5', displayFlag: true },
            { value: 'NO.5-1/4', text: 'NO.5-1/4', displayFlag: false },
            { value: 'NO.5-1/2', text: 'NO.5-1/2', displayFlag: false },
            { value: 'NO.6', text: 'NO.6', displayFlag: true },
            { value: 'NO.7(正)', text: 'NO.7(正)', displayFlag: true },
            { value: 'NO.7(反)', text: 'NO.7(反)', displayFlag: true },
            { value: 'NO.12', text: 'NO.12', displayFlag: true },
            { value: 'HS-556', text: 'HS-556', displayFlag: true }
        ]
    }, {
        id: 'bottleSpacing',
        optionList: [
        ...
        id: 'nrGauge',
        optionList: [
            { value: '0.8mm', text: '0.8mm' },
            { value: '0.8mm', text: '1.2mm' }
        ]
    }, {
        id: 'coolingPressure',
        optionList: [
    ...
    return new Promise(function(resolve, reject) {
        selectList[18].optionList = [];
        let queryString = 'SELECT * FROM productionHistory.dbo.isProdDataGlassRun ORDER BY schedate DESC,PRDT_SNM;';
        utility.executeQuery(queryString, function(glassRunRecordset, error) {
            if (error) {
                utility.logger.error('univeralForm - glassRun', error);
                reject(error);
            }
            glassRunRecordset.forEach(function(glassRunRecord) {
                ...
                if (glassRunRecord.existingIsProdDataRecord === 1) { text += ' *'; }
                if (glassRunRecord.sampling === 1) { text += ' (試)'; }
                selectList[18].optionList.push({
                    value: value,
                    text: text,
...
let checkboxList = function() {
    let checkboxList = [{
        id: 'conveyorHeating',
        multiSelect: false,
        optionList: [
            { value: true, text: '有', default: false },
            { value: false, text: '無', default: false }
        ]
    }, {
...
let autoCompleteList = function() {
    let autoCompleteList = [{
        id: 'glassProdLineID',
        mirrorTarget: 'machno',
        minLength: 0,
        optionList: [
            { label: 'L1-1', value: '1-1 1-1線' },
            { label: 'L1', value: '01 1線' },
            { label: 'L2', value: '02 2線' },
            { label: 'L3', value: '03 3線' },
            { label: 'L5', value: '04 5線' },
            { label: 'L6', value: '05 6線' },
            { label: 'L7', value: '06 7線' },
            { label: 'L8', value: '07 8線' }
        ]
    }, {
    ...
    return new Promise(function(resolve, reject) {
        autoCompleteList[1].optionList = [];
        let queryString = 'SELECT SNM AS label,PRD_NO AS value FROM DB_U105.dbo.PRDT WHERE PRD_NO LIKE \'B[0-9][0-9][0-9][0-9][0-9]__\';';
        utility.executeQuery(queryString, function(prdtRecordset, error) {
            if (error) {
                utility.alertSystemError('universalForm - ERP PRDT', error);
                reject(error);
            }
            prdtRecordset.forEach(function(prdtRecord) {
                autoCompleteList[1].optionList.push({
                    value: prdtRecord.value,
                    label: prdtRecord.label
                });
            });
            resolve({
